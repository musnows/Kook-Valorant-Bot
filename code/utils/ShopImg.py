...
bg_window_169_WithOutLogo = Image.open(
    io.BytesIO(requests.get('https://img.kookapp.cn/assets/2022-10/uFfgpWWlDy0zk0k0.png').content))  # 16-9 图片透明背景框，无水印
bg_window_169 = Image.open(
    io.BytesIO(requests.get('https://img.kookapp.cn/assets/2022-09/rLxOSFB1cC0zk0k0.png').content))  # 16-9 图片透明背景框,有水印
